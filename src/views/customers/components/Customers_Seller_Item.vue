    ...
    <v-card border variant="flat">
      <v-card-item>
        ...
        <div class=" mt-2">
          ...
          <v-btn @click="add_report_dialog = true" color="teal" size="30" class="me-3" variant="flat" icon="mdi-text-box-edit font-22" title="ثبت گزارش"></v-btn>
          <v-dialog
          ...
          <v-btn @click="add_invoice_dialog = true" color="indigo" size="30" variant="flat" icon="mdi-currency-usd font-22" title="ثبت فاکتور"></v-btn>
          <v-dialog
          ...
          >
            <v-card variant="flat" rounded class="pa-0">
              <v-card-item>
                <v-btn @click="add_invoice_dialog = false" variant="flat" density="compact" class="float-end" icon="mdi-close font-18" size="20" color="red-darken-1"></v-btn>
                <h4>ثبت فاکتور جدید برای مشتری</h4>
              </v-card-item>
              <v-divider/>
              <v-card-item class="pa-2">
                <actions_customer_invoice_create @Created="(get_item) => Create_Invoice(get_item)" :customer="customer"></actions_customer_invoice_create>
