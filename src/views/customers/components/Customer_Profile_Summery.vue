  ...
  <template v-if="customer">
    ...
    <div class="mt-5">
      <div>
        ...
        <strong class="ms-2 text-teal-darken-2"> گزارشات ثبت شده برای مشتری ( 5 گزارش آخر )</strong>
      </div>
      <div class="mt-6">
    ...
    <div class="mt-7">
      <div>
        ...
        <strong class="ms-2 text-deep-orange-darken-2">فاکتور های ثبت شده برای مشتری ( 5 فاکتور آخر )</strong>
      </div>
      <div class="mt-6">
